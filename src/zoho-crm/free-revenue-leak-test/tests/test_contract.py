...
class FreeRevenueLeakTestCrmPackageTests(unittest.TestCase):
    ...
    def test_form1_deluge_template_is_record_bound_and_opens_only_token_url(self) -> None:
        ...
        self.assertEqual(caller["success_response"]["open_target"], "new window")
        self.assertIn('openUrl(destination_url,"new window");', source)
        self.assertNotIn('"same window"', source)
