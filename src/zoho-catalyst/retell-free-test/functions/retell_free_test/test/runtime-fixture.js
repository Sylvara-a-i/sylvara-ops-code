...
function environment(overrides = {}) {
  return {
    ...
    RETELL_WEBHOOK_API_KEY: 'retell-development-verification-key',
    ...
    NUMBER_LOOKUP_HMAC_SECRET: 'number-runtime-secret-material-bbbbbbb',
    INTERNAL_READINESS_TOKEN: 'readiness-runtime-secret-material-cccc',
