...
- Development definition readback: **Node 24, 256 MB, 54 preserved live variable names versus 26 public-registry names, exact source-revision stamp, disabled-mode configuration readback, and archive-pullback byte parity to the exact upload; extra names are privately unclassified, configuration-registry parity is not proven, and no runtime `DisabledNoOp` was executed**
