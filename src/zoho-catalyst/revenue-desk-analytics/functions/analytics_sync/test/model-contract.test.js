...
const SPECIFIC = {
  ...
  call: [
    'CALL_KEY', 'STARTED_AT', 'ENDED_AT', 'DURATION_SECONDS', 'DURATION_MILLISECONDS', 'CALL_STATUS', 'OUTCOME',
  ...
  daily_metric: [
    ...
    'UNRESOLVED_CALLS', 'GENERAL_INQUIRY_CALLS', 'PRIVACY_STOP_CALLS',
    'BOOKABLE_OPPORTUNITIES', 'OFFICE_FOLLOW_UP_CALLS',
  ],
  final_test_result: [
...
test('renders five exact public-safe create-table payloads with complete fact schemas', () => {
  ...
  assert.deepEqual(nullable, {
    deployment: ['COVERAGE_MODE', 'STOPPED_AT', 'STOP_REASON',
      ...
      'PRETEST_AVERAGE_JOB_VALUE_BAND', 'PRETEST_MONTHLY_ANSWERING_COST_MINOR_UNITS'],
    call: [
      'ENDED_AT', 'DURATION_SECONDS', 'DURATION_MILLISECONDS', 'URGENCY_CLASS', 'COVERAGE_MODE',
    ...
    daily_metric: ['GENERAL_INQUIRY_CALLS', 'PRIVACY_STOP_CALLS', 'BOOKABLE_OPPORTUNITIES', 'OFFICE_FOLLOW_UP_CALLS'],
