...
[`config/datastore-schema.json`](config/datastore-schema.json) is proposed only. Fresh metadata, permissions, counts, digests, samples, conflicts, and source/destination readback are mandatory before provisioning or migration.
