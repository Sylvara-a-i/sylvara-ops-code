...
controller_subpath="src/zoho-catalyst/revenue-leak-test-setup-form"
...
run_isolated_npm "$test_npm_config" "$test_npm_cache" \
  --prefix "$test_project_root/functions/revenue_leak_test_setup_form" \
  ci --omit=dev --ignore-scripts --no-audit --no-fund
manifest_tree \
  "$test_project_root/functions/revenue_leak_test_setup_form/node_modules" \
...
run_isolated_npm "$deploy_npm_config" "$deploy_npm_cache" \
  --prefix "$deploy_project_root/functions/revenue_leak_test_setup_form" \
  ci --omit=dev --ignore-scripts --no-audit --no-fund
run_isolated_npm "$deploy_npm_config" "$deploy_npm_cache" \
  --prefix "$deploy_project_root/functions/revenue_leak_test_setup_form" ls --all >/dev/null
manifest_tree \
  "$deploy_project_root/functions/revenue_leak_test_setup_form/node_modules" \
...
deploy_function_node_modules="$deploy_project_root/functions/revenue_leak_test_setup_form/node_modules"
...
source_revision_path="$deploy_project_root/functions/revenue_leak_test_setup_form/lib/source-revision.js"
reference_revision_path="$reference_project_root/functions/revenue_leak_test_setup_form/lib/source-revision.js"
form_destination_path="$deploy_project_root/functions/revenue_leak_test_setup_form/lib/form-destination.js"
...
function_dependency_subtree="functions/revenue_leak_test_setup_form/node_modules"
...
deploy_function_root="$deploy_project_root/functions/revenue_leak_test_setup_form"
...
if ! (
  ...
  "$catalyst_path" deploy \
    --only functions:revenue_leak_test_setup_form \
    --ignore-scripts \
    --project "$PROJECT_ID" \
    --org "$CATALYST_ORG" \
    --dc us
