...
- [`docs/adr/0004-retell-catalyst-crm-analytics-integration-boundary.md`](docs/adr/0004-retell-catalyst-crm-analytics-integration-boundary.md) defines the proposed client-agent lifecycle, Retell webhook ingress, Catalyst call state, CRM summary boundary, customer-system reconciliation, Analytics reporting path, and direct-API-versus-MCP split. It is documentation-only and does not prove that any live component exists.
...
- [`docs/runbooks/retell-catalyst-analytics-reporting.md`](docs/runbooks/retell-catalyst-analytics-reporting.md) sequences Development verification, webhook ingress, durable call state, CRM summaries, customer-system reconciliation, Analytics bulk sync, fixed-client reports, containment, and Production approval.
