...
- [`docs/zoho/mcp/reference/tool-manual-tool-catalog-2026-08-05.json`](docs/zoho/mcp/reference/tool-manual-tool-catalog-2026-08-05.json) preserves all 10,817 rendered Tool Manual name rows across 61 services as a names-only reference; it does not imply Sylvara selection or access.
- [`docs/zoho/mcp/snapshots/configured/2026-08-04/enabled-tool-catalog.md`](docs/zoho/mcp/snapshots/configured/2026-08-04/enabled-tool-catalog.md) documents which 294 selections were observed across 18 neutral Sylvara MCP roles. Annotated names are prefix-free, such as `list vendor credits`; the dated snapshot is not proof of current tenant access or live-use approval.
