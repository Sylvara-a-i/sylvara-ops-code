# ADR 0002: Managed Home-Service Receptionist Product Boundary
...
Sylvara needs one initial audience, one operational problem, and one controlled delivery model. A private strategy review recommended home-service call conversion as the strongest first validation path. Its private research, vendor comparisons, commercial models, source material, and detailed roadmap are not publication evidence and remain outside this public repository.

## Decision

Sylvara will use the following boundary for product and technical work during validation:

1. Focus first on Kansas City home-service operators with meaningful inbound-call and dispatch needs.
...
8. Defer property management and other verticals until the home-service operating template is repeatable and a separate reviewed decision authorizes expansion.
...
Rejected because home services, property management, healthcare, legal, and other industries have materially different workflows, integrations, escalation risks, and compliance requirements.
...
- the home-service problem or initial coverage mode does not create measurable value;
