...
| Zoho WorkDrive | Private document contents, versions, hierarchy, and controlled sharing metadata | CRM relationship or accounting facts | MCP contracts were observed, but current tenant identity, grants, hierarchy, and effective access remain unverified |
