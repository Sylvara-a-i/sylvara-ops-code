...
| Approved CRM | Account, contact, opportunity, and approved operational relationship records | Accounting balances, subscription billing, call recordings, secrets, or raw production payloads | Zoho CRM organization identity and scoped module, field, layout, picklist, and record capabilities were verified on 2026-08-05. Native Lead-conversion writes and product integration remain unverified; see the dated suite registry. |
