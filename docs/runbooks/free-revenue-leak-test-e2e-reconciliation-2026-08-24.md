...
The six canonical function definitions are now present in Catalyst Development at revision `7fb101d60e4480a2aaa88de70d82d6b1ddc9e989`, with exact source-stamp, Node 24, 256 MB, safe-gate, Security Rule, pool, and retry-Cron readback. All six Catalyst-pulled archives match their exact uploaded archives byte for byte by SHA-256 and length; digests and private paths remain outside Git. No operator function or Job invocation was performed. CRM has 45 live variable names versus 42 public-registry names, and Analytics has 54 versus 26; extra names remain privately unclassified and omitted. Analytics disabled mode is configuration readback only, not a runtime `DisabledNoOp` proof. CRM paid/probe gates do not disable `sync_report_summary`, so no-invocation evidence is not proof that the callable surface is inert. This exact-upload archive evidence is not final-main or configuration-registry parity, route-count or negative direct-caller/runtime-invocation inventory, twelve-route API Gateway parity, Job-target/Cron or legacy-caller binding proof, synthetic runtime acceptance, Retell acceptance, migration/cleanup proof, or dark-Production proof; those remain release blockers.
...
| Call worker | One private Job target with four explicit modes | The canonical Job definition has exact source-stamp/Node 24/256 MB readback with zero variables. The operator performed no Job invocation; negative runtime-invocation inventory, Job-target/Cron binding, scheduler and legacy-caller reconciliation, and all four live mode contracts remain unproven. | P1 blocked |
...
| Analytics | Canonical `analytics_sync`, checkpoints, outbox, dashboards, retry, and freshness | The Development Job definition has exact source-stamp/Node 24/256 MB readback with 54 live variable names versus 26 public-registry names. Its mode read back disabled as configuration; no runtime `DisabledNoOp` was proven. The operator performed no Job invocation; negative runtime-invocation inventory, Job-target/Cron binding, and scheduler/legacy-caller reconciliation are unproven, and `RevenueDeskRetry1m` is absent. Two plausible owned workspaces still make target binding ambiguous, neither dashboard exists, and version-2 provider write/readback, migration, freshness, and dashboard readback remain unproven. | P1 blocked |
| Development deployment | Exact final-main six-function artifact/runtime parity and synthetic E2E | All six definitions have exact reviewed-revision source-stamp/runtime metadata readback and 6/6 archive-pullback parity to their exact uploads. No operator invocation was performed, but callable-surface inertness and negative runtime-invocation inventory are not proven. Configuration-registry parity, route-count readback, negative direct-caller inventory, twelve-route API Gateway parity, Job-target/Cron and legacy-caller bindings, invocation acceptance, synthetic E2E, final-main, and rollback acceptance remain incomplete. | P1 blocked |
...
Current status is **NOT READY FOR RETELL AGENT TESTING**. The canonical Catalyst Development definitions are installed with exact-upload archive parity and no operator invocation performed, but callable-surface inertness, negative runtime-invocation inventory, final-main/configuration parity, routes, bindings, invocation acceptance, Forms/CRM/Billing/Analytics acceptance, migration, cleanup, Production, security, isolation, and rollback work remains.
