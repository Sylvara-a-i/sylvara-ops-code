...
The 2026-08-24 sanitized metadata summary proves only a count. Self-authored release field lists do not extend the authoritative 2026-08-14 field, type, picklist, or active-layout snapshots. Any transition field absent from those snapshots requires fresh authoritative metadata and layout evidence before Blueprint deployment.
