...
3. Compare the Tool Manual, template membership, and currently advertised tool names without conflating them or inferring missing request and response contracts.
