...
The historical [Free-Test CRM MCP Allowlist](proposals/2026-08-14/sylvara-free-test-crm-mcp-allowlist.md) maps the originally proposed least-privilege subset to the Form 1 and Form 2 workflow. It is a superseded design record, not the current build runbook.
